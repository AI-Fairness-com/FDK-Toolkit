...
class FinanceFairnessPipeline:
    ...
    def calculate_error_prediction_fairness(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        # Calculate differences (ratios removed as redundant)
    ...
    def calculate_statistical_inequality(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        if len(selection_rates) >= 2:
            ...
            # 13. Generalized Entropy Index (Theil index removed as redundant)
    ...
    def calculate_subgroup_bias_detection(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        # 14. Error Rate difference (ratio removed as redundant)
    ...
    def run_pipeline(self, df: pd.DataFrame, save_to_disk: bool = True) -> Dict[str, Any]:
        ...
        try:
            ...
            # STANDARDIZED DATASET OVERVIEW - SOP COMPLIANCE
            group_counts = {}
            for group in df['group'].unique():
                group_mask = df['group'] == group
                group_counts[group] = int(df[group_mask].shape[0])
            ...
            results = {
                ...
                "validation": {
                    ...
                    "groups_analyzed": num_groups,
                    "group_counts": group_counts,
                    "statistical_power": "adequate" if total_records >= 100 else "limited"
                },
                "summary": {
