...
# reference implementation) -- powers the confirmation-page manual-
# override UX. Governance's own binary convention is strict {0,1} only,
# matching the existing _is_binary_column helper used elsewhere in this
# file.
# ================================================================
